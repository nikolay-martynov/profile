...
Полный цикл разработки и поддержки интеграционных решений в сфере систем эксплуатационной поддержки (Operations Support Systems) для операторов связи по всему миру:
...
Поиск и реализация технических и организационных решений для выполнения стратегий и политик вышестоящего руководства и корпорации:
...
- соответствие индустриальным стандартам (3GPP, TMF, ITU-T)

Ключевые технологии и методологии: Groovy, Java, C++, Bash/POSIX shell, Asciidoctor, Gradle, Maven, Autoconf/Automake, JSON, XML, XSLT, XSD, REST, WSDL, JMS, ActiveMQ, Kafka, SNMP, plain TCP, Docker, Spring, Camel, Apache commons, Spock, Boost, Poco, Linux (RHEL), HP-UX, Jenkins, Nexus, GitHub, Subversion, Jira, Wekan, Titra, Scrum, Kanban, Kaizen, WORST, SAFe, TDD
