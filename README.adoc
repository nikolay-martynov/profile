...
* link:blog/2022-07-13-Algorithms-illuminated-np.adoc[Совершенный алгоритм. Жадные алгоритмы и динамическое программирование]
...
image:images/Рекомендательное-письмо-HPE-без-телефона.jpg[link=images/Рекомендательное-письмо-HPE-без-телефона.jpg]
