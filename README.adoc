...
+
image::images/2013-hp-silver-rock-star-small.png[link=images/2013-hp-silver-rock-star.png]

* Agile Project Management: P&G Certified Scrum Master
** August 2012
** Procter & Gamble for Hewlett-Packard
+
image::images/2012-08-29-pg-certified-scrum-master.png[link=images/Martinov_Nickolay_PG_Scrum_Certification.pdf]
