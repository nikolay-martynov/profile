...
== Licenses & awards & certifications & courses & education
...
* Red Hat JBoss Fuse with Red Hat JBoss A-MQ and CamelRed Hat JBoss Fuse with Red Hat JBoss A-MQ and Camel
** October 2012
** JB439
